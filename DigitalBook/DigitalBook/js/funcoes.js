function validar() {
    ...
    if (usuario == '' && senha == '' && tipo == '') {
        window.alert('Preencha os campos usuário e senha e escolha o tipo de usuário!');
        ...
        window.alert('Preencha os campos usuário e senha!');
        document.getElementById('usuario').style.border = 'solid 0.5px red';
        document.getElementById('senha').style.border = 'solid 0.5px red';
    }else if(usuario == '' && senha != '' && tipo == ''){
        window.alert('Preencha os campos usuário e tipo!');
        document.getElementById('usuario').style.border = 'solid 0.5px red';
        document.getElementById('senha').style.border = 'solid 0.5px black';
    }else if(usuario != '' && senha == '' && tipo == ''){
        window.alert('Preencha os campos senha e tipo!');
        document.getElementById('senha').style.border = 'solid 0.5px red';
